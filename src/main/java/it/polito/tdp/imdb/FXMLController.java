...
public class FXMLController {
	...
	void doAttoriSimili(ActionEvent event) {
		for (Actor a : model.getConnectedActors(boxAttore.getValue())) {
	...
	void doSimulazione(ActionEvent event) {
		model.simula(Integer.parseInt(txtGiorni.getText()));
		List<Actor> result = model.getIntervistati();
		int nPaus = model.getnPaus();
		txtResult.setText("Giorni di pause: " + nPaus + "\n");
	...
	public void setModel(Model model) {
		this.model = model;
		boxGenere.getItems().addAll(model.getAllGenre());
	}
}
